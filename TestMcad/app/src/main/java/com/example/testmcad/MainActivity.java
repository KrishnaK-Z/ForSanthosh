...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_get_data) {
            navbarIntent = new Intent(this, GetSensorData.class);
            startActivity(navbarIntent);

        } else if (id == R.id.nav_share_data) {
            navbarIntent = new Intent(this, ShareSensorData.class);
            startActivity(navbarIntent);
        }
